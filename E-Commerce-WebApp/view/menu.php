            ...
            <div id="login_out">
                <?php
                                    if(isset($_SESSION["logged"])){
                                        echo '
                                        <li>
                                    <a href="register.php" style="float:right;font-size:20px">Sign Up</a>
                                    </li>
                                    <li>
                                    <a href="logout.php" style="float:right;font-size:20px">Log Out</a>
                                    </li>
                                    <li>
                                    <a href="cart.php" style="float:right;font-size:20px">My Cart</a>
                                    </li>
                                        ';
                                    }
                                     else
                                    ...
                                    <li>
                                    <a href="login.php" style="float:right;font-size:20px">Log In</a>
                                    </li>
                                    <li>
                                    <a href="cart.php" style="float:right;font-size:20px">My Cart</a>
                                    </li>
